...
public class TestNgXml {
	...
	public static void execution() {
		 try {
	         ...
	         Attr parameterattr1 = doc.createAttribute("name");
	         parameterattr1.setValue("browserName");
	         parameter.setAttributeNode(parameterattr1);
	         
	         Attr value= doc.createAttribute("value");
	         value.setValue("Firefox");
	         parameter.setAttributeNode(value);
	         
	         Element parameter1 = doc.createElement("parameter");
	         test.appendChild(parameter1);
	         
	         Attr parameterattr11 = doc.createAttribute("name");
	         parameterattr11.setValue("browserName");
	         parameter1.setAttributeNode(parameterattr11);
	         
	         Attr value1= doc.createAttribute("value");
	         value1.setValue("Chrome");
	         parameter1.setAttributeNode(value1);
	         */
